            ...
            <div className="min-h-screen bg-white relative">
                ...
                <main className="max-w-7xl mx-auto px-4 py-6">
                    ...
                    <div className="mb-10 relative">
                            ...
                            <button className="absolute left-2 top-1/2 -translate-y-1/2 bg-gray-800 bg-opacity-50 rounded-full p-1 text-white">
                                <ChevronLeft className="w-6 h-6" />
                            </button>
                            <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-gray-800 bg-opacity-50 rounded-full p-1 text-white">
